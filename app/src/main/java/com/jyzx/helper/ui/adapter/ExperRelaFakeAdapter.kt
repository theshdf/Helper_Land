 ...
 * 专家相关的适配器
 */
class ExperRelaFakeAdapter(resId: Int, data: ArrayList<VideoBean>, context: Context?) : BaseQuickAdapter<VideoBean,BaseViewHolder>(resId,data){

    override fun convert(holder: BaseViewHolder, item: VideoBean) {
        holder.setText(R.id.tvTitle,item.title)
        holder.setText(R.id.tvDes,"点击量1200")
