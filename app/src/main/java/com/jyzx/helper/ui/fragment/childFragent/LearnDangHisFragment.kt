...
class LearnDangHisFragment : BaseFragment() {
    ...
    private fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getLearnGangHis())
        guideDatas.addAll(FakeDataUtil.getLearnGangHis().subList(0,2))
    }
    ...
    private fun addHeader(){
        ...
        tvView.text = Constants.DANGHIS_QUESTION
