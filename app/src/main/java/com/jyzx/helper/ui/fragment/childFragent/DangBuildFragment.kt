...
class DangBuildFragment : BaseFragment() {
    ...
    fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getDangBuild())
        var data = FakeDataUtil.getDangBuild().subList(0,3)
        data.removeAt(1)
        guideDatas.addAll(data)
    }
    ...
    private fun addHeader(){
        ...
        tvView.text = Constants.DANGBUILD_QUESTION
