...
class NumberBuildFragment : BaseFragment() {
    ...
    fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getNumberBuild())
        guideDatas.addAll(FakeDataUtil.getNumberBuild().subList(0,2))
    }
    ...
    private fun addHeader(){
        ...
        tvView.text = Constants.NUMBERBUILD_QUESTION
