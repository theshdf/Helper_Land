...
/**
user: Administrator
date:2021/8/4  EcoConstuctionFragment
EXP:生态文明
 */

class EcoCultureFragment : BaseFragment() {
    ...
    fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getEcoCult())
        guideDatas.addAll(FakeDataUtil.getEcoCult().subList(0,2))
    }
    ...
    private fun addHeader(){
        ...
        tvView.text =Constants.ECOCULTURE_QUESTION
