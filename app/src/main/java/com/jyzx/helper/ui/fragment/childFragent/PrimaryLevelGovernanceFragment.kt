...
class PrimaryLevelGovernanceFragment : BaseFragment() {
    ...
    override fun initData() {
        ...
        solveAdapter?.setOnItemClickListener { _, _, position ->
        ...
        guideAdapter?.setOnItemClickListener { _, view, position ->
            view?.determineTriggerSingleClick {
    ...
    fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getPrimaryLevelGovernance())
        guideDatas.addAll(FakeDataUtil.getPrimaryLevelGovernance().subList(0,2))
    }
    ...
    private fun addHeader(){
        ...
        tvView.text =Constants.PRIMARYLEVELGONVANCE_QUESTION
