...
class EcoBuildFragment : BaseFragment() {
    ...
    fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getEcoBuild())
        guideDatas.addAll(FakeDataUtil.getEcoBuild().subList(0,2))
    }
    ...
    private fun addHeader(){
        ...
        tvView.text = Constants.ECODEVLOP_QUESTION
