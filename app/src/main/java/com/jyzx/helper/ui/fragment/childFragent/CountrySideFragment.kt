...
class CountrySideFragment : BaseFragment() {
    ...
    override fun initData() {
        ...
        addHeader()
        refresh.setColorSchemeColors(Color.parseColor("#1AA77A"))
    ...
    fun initFakeData(){
        ...
        solveDatas.addAll(FakeDataUtil.getCountryVideo())
        guideDatas.addAll(FakeDataUtil.getCountryVideo().subList(0,2))
    }
    ...
    private fun addHeader(){
        ...
        tvView.text = Constants.COUNTRYSIDEBUILD
