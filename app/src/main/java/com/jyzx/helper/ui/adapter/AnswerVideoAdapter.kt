...
class AnswerVideoAdapter(res: Int, datas: ArrayList<VideoBean>, context: Context?) : BaseQuickAdapter<VideoBean,BaseViewHolder>(res,datas) {

    override fun convert(holder: BaseViewHolder, item: VideoBean) {
        holder.setText(R.id.tvTitle,item.author+"  的回答")
