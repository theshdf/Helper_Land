package com.jyzx.helper.http.error;
...
public class ErrorInfo {
    ...
    public ErrorInfo(Throwable throwable) {
        ...
        if (throwable instanceof UnknownHostException) {
            if (!ExceptionHelper.isNetworkConnected(HelperApplication.Companion.getInstance())) {
    ...
    public boolean show() {
        RxToast.showToast(TextUtils.isEmpty(errorMsg) ? throwable.getMessage() : errorMsg);
        return true;
    }
    ...
    public boolean show(String standbyMsg) {
        RxToast.showToast(TextUtils.isEmpty(errorMsg) ? standbyMsg : errorMsg);
        return true;
    }
    ...
    public boolean show(int standbyMsg) {
        RxToast.showToast(TextUtils.isEmpty(errorMsg) ?HelperApplication.Companion.getInstance().getString(standbyMsg) : errorMsg);
        return true;
    }

    public String getString(int resId) {
        return HelperApplication.Companion.getInstance().getString(resId);
    }
}
